const questions = [
    ...
    { q: "卓越と優越について、間違っているものはどれ？", a: ["卓越は絶対的な突出", "優越は相対的な比較", "卓越は比較対象がなければならない", "優越は立場・地位・感情を表すときに使う"], c: 3 },
    ...
    { q: "「あやまち、過失」を意味し、「落ち度」の語源とされる言葉は？", a: ["越度（おちど）", "越階（おっかい）", "越訴（おっそ）", "越境（えっきょう）"], c: 0 },
    { q: "役人が通常の順序を飛び越えて昇進することを指す言葉は？", a: ["越度", "越階（おっかい）", "越訴", "越境"], c: 1 },
    { q: "正規の手続きを無視して最高権力者に訴え出る行為を指す言葉は？", a: ["越度", "越階", "越訴（おっそ）", "越境"], c: 2 },
